    ...
    return (
        <div className="gameover" style={visible}>
            <ul className="secret">
                ...
                <li><input type="text" placeholder="Enter Player Name" className="player-name"/><button type="button" className="save">Save</button></li>
                <li><button type="button"  onClick={props.gameRestart} >Restart</button></li>
                <li><button type="button"  onClick={props.gameScore} >Score</button></li>
            </ul>
